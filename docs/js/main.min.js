...
},{"../lib/extend-namegen":6,"../lib/namegen.js":8,"./background-switcher":1}],3:[function(require,module,exports){
const ADJECTIVES = [
'Supreme',
'Amazing',
'Incredible',
...
Object.assign(NameGen.symbols,{
    ...
    Q:require("./animals"),
    G:require("./girl-names")
});

module.exports ={}
},{"./adjectives":3,"./animals":4,"./css-colors":5,"./girl-names":7,"./namegen":8}],7:[function(require,module,exports){
